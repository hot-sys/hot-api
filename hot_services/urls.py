...
urlpatterns = [
    ...
    path('commande/search-received', search_commande_received, name='search_commande_received'),
    ...
    path('commande/toreceived', get_all_commande_received, name='get_all_commande_received'),
